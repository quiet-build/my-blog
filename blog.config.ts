...
const BLOG = {
  ...
  comment: {
    // support provider: gitalk, utterances, cusdis, lit-talk
    provider: 'lit-talk',
    litTalkConfig: {
      client_id: 'PLACEHOLDER_CLIENT_ID', // Replace with your GitHub OAuth App client ID
      owner: 'matwming',
      repo: 'my-nextjs-blog',
      proxy: 'https://lit-talk-oauth-proxy.matwming.workers.dev' // Cloudflare Worker CORS proxy for GitHub OAuth token exchange
    },
    gitalkConfig: {
